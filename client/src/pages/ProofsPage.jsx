...
const ProofImage = ({ src, alt, className, fallbackClassName = '' }) => {
  ...
  if (!imageSrc || failed) {
    return (
      <div className={`flex items-center justify-center text-[var(--color-text-secondary)] text-sm ${fallbackClassName}`}>
        Image unavailable
      </div>
    );
  }
              ...
              <div className="relative min-h-[300px] bg-black flex items-center justify-center">
                {activeImage ? (
                  <ProofImage
                    ...
                    fallbackClassName="min-h-[300px] w-full"
                  />
                ) : (
