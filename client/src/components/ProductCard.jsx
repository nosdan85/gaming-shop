  ...
  return (
    ...
    >
      ...
      <div className="flex-1 flex items-center justify-center my-3 md:my-4 relative z-10">
        <div className="relative w-[90%] h-[90%] max-w-[150px] max-h-[150px] md:max-w-[180px] md:max-h-[180px] bg-[var(--color-bg-secondary)] rounded-[8px] border border-[var(--color-border)] flex items-center justify-center p-2 md:p-3">
          <img
            src={productImageSrc}
            alt={product.name}
            loading="lazy"
